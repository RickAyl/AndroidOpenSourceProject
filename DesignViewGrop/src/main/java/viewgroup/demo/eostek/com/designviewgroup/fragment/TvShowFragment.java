package viewgroup.demo.eostek.com.designviewgroup.fragment;
...
public class TvShowFragment extends BaseFragment {
    ...
    private int[] mImgIds = new int[]{R.drawable.guide_tvshow1b,
            R.drawable.guide_tvshow2b, R.drawable.guide_tvshow3bb, R.drawable.guide_tvshow4,R.drawable.guide_tvshow5bb};

    private String[] strings = {"古装宫斗", "都市偶像", "经典韩流","火热美剧","日系治愈"};
